...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-tic-tac-toe-tic-tac-toe-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppPagesTicTacToeTicTacToeComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTicTacToeTicTacToeComponentScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppPagesTicTacToeTicTacToeComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    var TicTacToeComponent = /*#__PURE__*/function () {
      ...
      _createClass(TicTacToeComponent, [{
        ...
        key: "clickYourTurn",
        value: function clickYourTurn(column, row) {
          var _this = this;

          this.gameArray[row][column] = this.firstPlayer ? 'X' : 'O';

          var checkIfTrue = function checkIfTrue(theText) {
            return theText == (_this.firstPlayer ? 'X' : 'O');
          };

          var countDiagRight = 0,
              countDiagLeft = 0,
              countHori = 0,
              countVerti = 0,
              horiFull = 0,
          ...
          if (horiFull > 0 || vertiFull > 0 || countDiagLeft == this.gameLength || countDiagRight == this.gameLength) {
            setTimeout(function () {
              alert("".concat(_this.firstPlayer ? 'First' : 'Second', " Player Win the Game!"));

              _this.resetGame();
            });
          } else {
            var stringCount = '';
            this.gameArray.forEach(function (array) {
    ...
    TicTacToeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'tic-tac-toe',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./tic-tac-toe.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/tic-tac-toe/tic-tac-toe.component.html"))["default"],
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./tic-tac-toe.component.scss */
      "./src/app/pages/tic-tac-toe/tic-tac-toe.component.scss"))["default"]]
    })], TicTacToeComponent);
    /***/
  },
  ...
  /***/
  function srcAppPagesTicTacToeTicTacToeModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TicTacToeModule", function () {
    ...
    var _tic_tac_toe_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
    /*! ./tic-tac-toe.component */
    "./src/app/pages/tic-tac-toe/tic-tac-toe.component.ts");
    /* harmony import */


    var _tic_tac_toe_routing__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
    /*! ./tic-tac-toe.routing */
    "./src/app/pages/tic-tac-toe/tic-tac-toe.routing.ts");

    var TicTacToeModule = function TicTacToeModule() {
      _classCallCheck(this, TicTacToeModule);
    };

    TicTacToeModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppPagesTicTacToeTicTacToeRoutingTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "TicTacToeRoutingModule", function () {
    ...
    var _tic_tac_toe_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
    /*! ./tic-tac-toe.component */
    "./src/app/pages/tic-tac-toe/tic-tac-toe.component.ts");
    ...
    var TicTacToeRoutingModule = function TicTacToeRoutingModule() {
      _classCallCheck(this, TicTacToeRoutingModule);
    };

    TicTacToeRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
...
//# sourceMappingURL=pages-tic-tac-toe-tic-tac-toe-module-es5.js.map