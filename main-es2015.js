...
var map = {
	"./pages/employee-salt/employee.module": [
		"./src/app/pages/employee-salt/employee.module.ts",
		"default~pages-employee-salt-employee-module~pages-login-login-module~pages-tic-tac-toe-tic-tac-toe-module",
		"pages-employee-salt-employee-module"
	],
	...
	"./pages/tic-tac-toe/tic-tac-toe.module": [
...
/* harmony import */ var ngx_mat_select_search__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ngx-mat-select-search */ "./node_modules/ngx-mat-select-search/fesm2015/ngx-mat-select-search.js");
        ...
        imports: [
            ...
            _ngx_translate_core__WEBPACK_IMPORTED_MODULE_18__["TranslateModule"].forRoot({
                loader: {
                    ...
                    useFactory: (http) => new _ngx_translate_http_loader__WEBPACK_IMPORTED_MODULE_19__["TranslateHttpLoader"](http, './assets/i18n/', '.json'),
...
module.exports = __webpack_require__(/*! C:\Users\gojiberih\Private Project\AngularJS%20Project\employee-project\src\main.ts */"./src/main.ts");
